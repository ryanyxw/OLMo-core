"""
Train a Llama 70B model. Run this script without any arguments to see usage info.
"""
...
def build_model_config(common: CommonComponents) -> TransformerConfig:
    return TransformerConfig.llama3_70B(vocab_size=common.tokenizer.padded_vocab_size())
